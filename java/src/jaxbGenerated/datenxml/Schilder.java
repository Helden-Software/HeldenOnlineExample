 ...
 *       &lt;sequence>
 *         &lt;element ref="{}schild" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "schilder")
public class Schilder {

    protected List<Schild> schild;
    @XmlAttribute(name = "inbenutzung", required = true)
    protected boolean inbenutzung;

    /**
     * Gets the value of the schild property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the schild property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSchild().add(newItem);
     * </pre>
     * 
     * 
     * <p>
